...
namespace FOMOD_Creator.Models.ModuleConfiguration.Files
{
    ...
    public class FileSystemItem
    {
        ...
        /// <summary>
        /// Indicates that the file or folder should always be installed, regardless of whether or not the plugin has been selected.
        /// </summary>
        ...
        /// <summary>
        /// Indicates that the file or folder should always be installed if the plugin is not NotUsable, regardless of whether or not the plugin has been selected.
        /// </summary>
